...
/**/		let todo = {title : 'my todo', completed: false};
	...
	describe('toggle all', function () {
		...
		it('should update the view', function () {
			let todo = {id : 24 , title: 'my todo', completed: false};
			setUpModel([todo]);

			subject.setView('');

			view.trigger('itemToggle', todo);
			expect(view.render).toHaveBeenCalledWith('elementComplete', Object({ id: 24, completed: false }));
		});
	});
	...
	describe('element removal', function () {
		it('should remove an entry from the model', function () {
			var todo = {id: 16, title: 'my todo', completed: true};
			setUpModel([todo]);

			subject.setView('');
			view.trigger('itemRemove', {id: 16});

			expect(model.remove).toHaveBeenCalledWith(16, jasmine.any(Function));
		});
